...
<qgis simplifyAlgorithm="0" minScale="100000000" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" version="3.16.11-Hannover" simplifyLocal="1" simplifyMaxScale="1" readOnly="0">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="xcoord">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="ycoord">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="xcoord" index="8" name=""/>
    <alias field="ycoord" index="9" name=""/>
    <alias field="fid" index="10" name=""/>
    <alias field="part_of" index="11" name=""/>
  </aliases>
  <defaults>
    ...
    <default field="xcoord" applyOnUpdate="0" expression=""/>
    <default field="ycoord" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint field="xcoord" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
    <constraint field="ycoord" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="xcoord"/>
      <column hidden="0" type="field" width="-1" name="ycoord"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="xcoord"/>
    <field editable="1" name="ycoord"/>
  </editable>
  <labelOnTop>
